...
public class playerCharacter {
	...
	public playerCharacter() {
		...
		this.races = new String[] { "Dragonborn", "Dwarf", "Elf", "Gnome", "Half-Elf", "Half-Orc", "Halfling", "Human",
				"Tiefling" };
		this.alignments = new String[] { "Lawful Good", "Neutral Good", "Chaotic Good", "Lawful Neutral",
				"True Neutral", "Chaotic Neutral", "Lawful Evil", "Neutral Evil", "Chaotic Evil" };
		this.eyeColors = new String[] { "Amber", "Black", "Blue", "Brown", "Gold", "Gray", "Green", "Hazel", "Red" };
		this.hairColors = new String[] { "Auburn", "Black", "Brown", "Blond", "Red", "Grey", "White" };
		this.skinColors = new String[] { "Pale", "Fair", "Tan", "Brown", "Dark Brown", "Black", "Green", "Blue",
				"Red" };
		this.saves = new String[] { "Strength", "Dexterity", "Constitution", "Intelligence", "Wisdom", "Charisma" };
		this.skills = new String[] { "Acrobatics", "Animal Handling", "Deception", "Intimidation", "Investigation",

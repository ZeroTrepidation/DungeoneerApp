...
public class Event {
	...
	public static void displayEventWindow(Vector<Event> events, int index, DefaultListModel dlm) {
		...
		f.getContentPane().add(save);f.getContentPane().add(sessionSpin); f.getContentPane().add(sessionNum);
		f.getContentPane().add(description); f.getContentPane().add(descriptionLabel);
		f.getContentPane().add(gameTime); f.getContentPane().add(gameTimeLabel); f.getContentPane().add(gameWeather); f.getContentPane().add(gameWeatherLabel);
		f.getContentPane().add(sessionDate); f.getContentPane().add(sessionDateLabel);
		f.getContentPane().add(sessionLabel); f.getContentPane().add(sessionL);

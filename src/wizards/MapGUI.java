...
public class MapGUI {
	...
	private void initialize() {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup().addGap(88)
						.addComponent(btnGenerateDescription, GroupLayout.PREFERRED_SIZE, 166,
								GroupLayout.PREFERRED_SIZE)
						.addGap(130).addComponent(filter, GroupLayout.PREFERRED_SIZE, 117, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED, 140, Short.MAX_VALUE)
						.addComponent(condition, GroupLayout.PREFERRED_SIZE, 167, GroupLayout.PREFERRED_SIZE)
						.addGap(162).addComponent(btnReset, GroupLayout.PREFERRED_SIZE, 81, GroupLayout.PREFERRED_SIZE)
						.addGap(133))
				.addComponent(textArea, GroupLayout.DEFAULT_SIZE, 1184, Short.MAX_VALUE));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
						.addComponent(textArea, GroupLayout.PREFERRED_SIZE, 376, GroupLayout.PREFERRED_SIZE).addGap(18)

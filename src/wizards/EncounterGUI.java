...
public class EncounterGUI {
	...
	private void initialize() {
		...
		btn_Clear1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!(textField_enemy1.getText().equalsIgnoreCase(""))
						|| !(textField_enemy1.getText().equalsIgnoreCase(null))) {
		...
		btn_Clear2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!(textField_enemy2.getText().equalsIgnoreCase(""))
						|| !(textField_enemy2.getText().equalsIgnoreCase(null))) {
		...
		btn_Clear3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!(textField_enemy3.getText().equalsIgnoreCase(""))
						|| !(textField_enemy3.getText().equalsIgnoreCase(null))) {
		...
		btn_Clear4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!(textField_enemy4.getText().equalsIgnoreCase(""))
						|| !(textField_enemy4.getText().equalsIgnoreCase(null))) {
		...
		btn_Clear5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!(textField_enemy5.getText().equalsIgnoreCase(""))
						|| !(textField_enemy5.getText().equalsIgnoreCase(null))) {
		...
		btn_Clear6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!(textField_enemy6.getText().equalsIgnoreCase(""))
						|| !(textField_enemy6.getText().equalsIgnoreCase(null))) {
	...
	public void addEnemy(String Enemy) {
		...
		} else if (textField_enemy2.getText().equalsIgnoreCase("")
				|| textField_enemy2.getText().equalsIgnoreCase(null)) {
			textField_enemy2.setText(Enemy);
			number_of_enemies++;
		} else if (textField_enemy3.getText().equalsIgnoreCase("")
				|| textField_enemy3.getText().equalsIgnoreCase(null)) {
			textField_enemy3.setText(Enemy);
			number_of_enemies++;
		} else if (textField_enemy4.getText().equalsIgnoreCase("")
				|| textField_enemy4.getText().equalsIgnoreCase(null)) {
			textField_enemy4.setText(Enemy);
			number_of_enemies++;
		} else if (textField_enemy5.getText().equalsIgnoreCase("")
				|| textField_enemy5.getText().equalsIgnoreCase(null)) {
			textField_enemy5.setText(Enemy);
			number_of_enemies++;
		} else if (textField_enemy6.getText().equalsIgnoreCase("")
				|| textField_enemy6.getText().equalsIgnoreCase(null)) {
	...
	public void generateEncouter(String Difficulty) {
		...
		while ((encounter_xp < xp_level) && (counter < 6)) {
			...
			// System.out.printf("at 363, mosnter xp xp = ",
			// getMonsterObj(comboEnemyList.getItemAt(index).toString()).getXp());
	...
	public int getXP() {
		...
		if (!(textField_enemy1.getText().equalsIgnoreCase(null))
				&& !(textField_enemy1.getText().equalsIgnoreCase(""))) {
			xp += getMonsterObj(textField_enemy1.getText()).getXp();
		}

		if (!(textField_enemy2.getText().equalsIgnoreCase(null))
				&& !(textField_enemy2.getText().equalsIgnoreCase(""))) {
			xp += getMonsterObj(textField_enemy2.getText()).getXp();
		}

		if (!(textField_enemy3.getText().equalsIgnoreCase(null))
				&& !(textField_enemy3.getText().equalsIgnoreCase(""))) {
			xp += getMonsterObj(textField_enemy3.getText()).getXp();
		}

		if (!(textField_enemy4.getText().equalsIgnoreCase(null))
				&& !(textField_enemy4.getText().equalsIgnoreCase(""))) {
			xp += getMonsterObj(textField_enemy4.getText()).getXp();
		}

		if (!(textField_enemy5.getText().equalsIgnoreCase(null))
				&& !(textField_enemy5.getText().equalsIgnoreCase(""))) {
			xp += getMonsterObj(textField_enemy5.getText()).getXp();
		}

		if (!(textField_enemy6.getText().equalsIgnoreCase(null))
				&& !(textField_enemy6.getText().equalsIgnoreCase(""))) {
